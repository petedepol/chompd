  ...
  void seed() {
    final seeds = [
      _seed('NETFLIX.COM', 'Netflix', 0.99, MerchantTier.autoDetect, 8420,
          category: 'Entertainment', icon: 'N', color: '#E50914'),
