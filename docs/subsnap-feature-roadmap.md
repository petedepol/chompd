...
- **v1.0 focus:** Ship the core — manual CRUD, AI scan, reminders, paywall, basic gamification
- **v1.1 focus (1-2 months post-launch):** Quick wins from user feedback + shared tracking, price detection, cancel guides, renewal insights
- **v1.2 focus (3-4 months post-launch):** Wrapped, benchmarking, "should I keep this?" nudges, iCloud sync
